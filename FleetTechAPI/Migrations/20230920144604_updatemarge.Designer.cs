...
namespace FleetTechAPI.Migrations
{
    ...
    [Migration("20230920144604_updatemarge")]
    partial class updatemarge
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FleetTechCore.Models.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            DateCreated = new DateTime(2023, 9, 20, 10, 46, 3, 868, DateTimeKind.Local).AddTicks(2966),
                            Email = "superadmin@gmail.com",
                            FirstName = "Super",
                            LastName = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEGSg3IhKZrNKR+uU4Cao10sX781HJ/OObjT2LMcj+9YedZO2FDby50zX4YQ6jCXTCA==",
                            Phone = "(829) 123-4567",
                            Status = 1,
                            Username = "superadmin"
                        });
