...
namespace FleetTechAPI.Migrations
{
    ...
    [Migration("20230919003107_update")]
            ...
            modelBuilder.Entity("FleetTechCore.Models.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            DateCreated = new DateTime(2023, 9, 18, 20, 31, 6, 840, DateTimeKind.Local).AddTicks(4427),
                            Email = "superadmin@gmail.com",
                            FirstName = "Super",
                            LastName = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEII8jIB7OOMwh/jbVF70x2PLwz5kLCVCpF61QeVg3OM9VcQpQdttlxa/59BT/SYTpg==",
                            Phone = "(829) 123-4567",
                            Status = 1,
                            Username = "superadmin"
                        });
